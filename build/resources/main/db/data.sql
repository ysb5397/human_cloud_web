...
INSERT INTO announce_tb (company_id, title, content, work_location, start_date, end_date) VALUES
(1, '[네이버] 2025년 신입 백엔드 서버 개발자 채용', '네이버의 다양한 서비스들을 함께 만들어나갈 열정적인 신입 개발자를 모집합니다. 최고의 동료들과 함께 성장할 기회를 잡으세요.', '경기도 성남시', NOW(), '2025-07-31'),
(2, '[카카오] 프론트엔드 개발자 경력직 채용 (3년 이상)', '카카오톡, 다음 등 국민 서비스를 만들어나갈 프론트엔드 개발자를 찾습니다. JavaScript에 대한 깊은 이해가 있는 분을 우대합니다.', '제주특별자치도 제주시', NOW(), '2025-08-15'),
(3, '[라인] 글로벌 서비스 기획자 모집', '전 세계 수억 명이 사용하는 라인 메신저의 새로운 기능을 기획하고 개선할 인재를 찾습니다. 글로벌 마인드와 커뮤니케이션 능력이 중요합니다.', '경기도 성남시', NOW(), '2025-07-20'),
(4, '[쿠팡] 데이터 분석가 인턴십', '쿠팡의 방대한 데이터를 분석하여 물류, 커머스 혁신을 이끌어갈 데이터 분석가 인턴을 모집합니다. 통계적 지식과 분석 툴 활용 능력이 필요합니다.', '서울특별시 송파구', NOW(), '2025-07-10'),
(5, '[배달의민족] DevOps 엔지니어 채용', '배달의민족 서비스의 안정적인 인프라를 책임질 DevOps 엔지니어를 모집합니다. 클라우드 환경과 자동화에 대한 경험이 있는 분을 환영합니다.', '서울특별시 송파구', NOW(), '2025-08-01');
